...
public class SeekerProfileFragment extends Fragment {
    ...
    private TextView tv_name, tv_email, tv_jk, tv_hp, tv_alamat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv_hp = v.findViewById(R.id.tv_hp);
        ...
        bt_edit_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getContext(), SeekerProfilEditActivity.class));
            }
        });
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (!seekerProfile.getPic().equals("-")) {
                        Glide.with(getContext()).load(seekerProfile.getPic()).into(profile_pic);
                    }

                    tv_name.setText(seekerProfile.getName());
                    tv_email.setText(seekerProfile.getEmail());
                    tv_alamat.setText(seekerProfile.getAlamat());
                    tv_hp.setText(seekerProfile.getHp());
                    tv_jk.setText(seekerProfile.getJk());
